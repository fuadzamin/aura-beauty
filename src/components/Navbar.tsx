    ...
    <header className="sticky top-0 z-40 w-full bg-cream/90 backdrop-blur-md border-b border-gold/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            onClick={onBookClick}
            className="hidden sm:inline-flex items-center justify-center px-6 py-2.5 bg-gold text-white font-medium text-sm tracking-wide hover:bg-gold-light transition-all rounded-sm shadow-sm"
          >
            Reservasi Perawatan
          </button>
        </div>
